<template>
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="轮播图介绍">
        <el-input v-model="dataVo.describes" placeholder="请输入轮播图介绍"/>
      </el-form-item>
    ...
    >
      ...
      <el-table-column align="content" label="轮播图内容">
        <template slot-scope="scope">
    ...
    >
      <el-form :model="formData" label-position="left" label-width="120px">
        <el-form-item label="轮播图标题">
          <el-input v-model="formData.title" placeholder="请填写轮播图标题"/>
        </el-form-item>
...
<script>
import { deleteById, update, insert, pageQuery} from '@/api/banner'
